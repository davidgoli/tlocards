...
ActiveRecord::Schema.define(version: 20120212055953) do
  ...
  create_table "download_codes", force: :cascade do |t|
  ...
  create_table "downloads", force: :cascade do |t|
    ...
    t.string   "zipfile_file_name",    limit: 255
    t.string   "zipfile_content_type", limit: 255
    t.integer  "zipfile_file_size",    limit: 4
